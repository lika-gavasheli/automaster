...
<body>
        ...
        <section id="sectionone" class="section-one">
            ...
            @foreach ($sliders as $slider)
                    ...
                    @if($slider['alias']=='active')  

                <div class="carousel-item active">    
                  <img class="d-block w-100 car-img" src="{{$slider['img']}}" alt="{{$slider['name']}}">
                </div>
            ...
            <h1 class="bottom-text-h1">{{$main['date']}}</h1>
            <h2 class="bottom-text-h2">{{$main['title']}}</h2>
             @endforeach
        </section>
        ...
        <section id="sectiontwo" class="section-two">
            ...
            <div class="row services-row">
                ...
                <div class="services">                     
                    <img class="services-img" src="{{$service['icon']}}">
                    <a class="services-h2" href="#">{{$service['name']}}</a>                    
                </div>
                @endforeach
                     @endif 
         </div>
        ...
        <section id="sectionthree" class="section-three">
            <div class="map">
                ...
                <div class="bottom-box">
                 ...
                 <a class="social-icons-a" href="{{$social['url']}}">
                  <img class="social-icons-img" src="{{$social['icon']}}">
                </a>
...
<form  method="post">
                              ...
                              <div class="form-group">
                                <input type="text" name="text" class="form-control form-control-last-child" id="formGroupExampleInput" placeholder="text">
                              </div>    
                        ...
                        <button type="submit" value="send message" class="btn btn-dark">send</button>
                    </div>
        ...
        <footer class="footer">
            ...
            <p class="footer-p2">created by: BEQA CHALADZE & LIKA GAVASHELI</p>
        </footer>
